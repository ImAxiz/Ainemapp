...
function getAverage(numbers){
    ...
    return numbers.lenth===0 ? 0 : total / numbers.length;
}
...
function highestLowestTemperature(){
    ...
    document.write(`Kõrgeim temperatuur oli ${getMonthName(highestTempMonthNumber)} kuus ${highestTemp}kraadi.`);
    document.write(`Madalaim temperatuur oli ${getMonthName(lowestTempMonthNumber)} kuus ${lowestTemp}kraadi.`);
}